...
*/
   ...
   /* public ProgressDialog progressdialog(Context context) {
    ...
    public Spannable getSearchedTextHighlight(String searchItem, String fullItem) {
        ...
        if (fullItem.toLowerCase().contains(searchItem.toLowerCase())) {
            ...
            while (matcher.find()) {
                try {
                    ...
                    ColorStateList orangeColor = new ColorStateList(new int[][]{new int[]{}}, new int[]{Color.parseColor("#24c068")});
